...
To understand each step that is involved in successive creation of a container reading the following section is recommended. It should also help to understand the bootstrap script.
